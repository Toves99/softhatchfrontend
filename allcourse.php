...
curl_setopt_array($curl, array(
  CURLOPT_URL => '192.168.56.1:8080/api/v1/auth/listAllCourses',
...
<section id="courses" class="courses">
  ...
  <div class="container" data-aos="fade-up">
    ...
    <!-- <div class="row gy-4">
      <h5 style="color: green;">Software Development Courses</h5>

      <?php 
      //if(!empty($courseData) && isset($courseData['data'])): // Adjust according to your API response structure
      ...
      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
        <div class="course-box blue">
        <img src="assets/img/values-1.jpg">
          <h3><?php //echo htmlspecialchars($course['title']); ?></h3>
          <span>Java,flutter</span>
          <p><?php //echo htmlspecialchars($limited_description); ?></p>
          
            <span class="cost"><strong>Cost</strong> <?php //echo htmlspecialchars($course['cost']); ?></span>
            <span class="duration"><strong>Duration:</strong><?php //echo htmlspecialchars($course['course_duration']); ?></span>
